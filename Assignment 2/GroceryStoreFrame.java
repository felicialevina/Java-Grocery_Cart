...
public class GroceryStoreFrame extends JFrame
{
    ...
    private Boolean checkPickedUp = false;
	...
	*/
    ...
    /**
       ...
       Checks if picked up item is null, if null check variable is true
    */    
	...
	{
	    conveyer.addItem();
	    checkPickedUp = conveyer.checkPickedUp();
	    if(checkPickedUp == true)
		{
		    check = true;
		}
	}
